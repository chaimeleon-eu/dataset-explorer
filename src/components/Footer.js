...
function Footer(props) {
    ...
    return (
        <div className="d-flex justify-content-between w-100 p-1 text-black bg-light bg-gradient mt-4">
            <span className="ms-2"><img src={Config["basename"] + "/icons/eu.svg"} style={{height:"1em"}}/><b className="ms-2">CHAIMELEON Project</b>, DOI <a href="https://doi.org/10.3030/952172">10.3030/952172</a></span>
