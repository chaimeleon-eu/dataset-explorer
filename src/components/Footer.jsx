...
function Footer(props) {
    ...
    return (
        <div className="d-flex justify-content-between w-100 p-1 text-black bg-light bg-gradient mt-4 " style={{"fontSize":"0.75em"}}>
            ...
            <span className="ms-2 me-2">Copyright© <a href="https://www.upv.es/en">UPV</a> 2020-2024 | <a href={process.env.PUBLIC_URL + "/terms-and-conditions.pdf"}>Terms & Conditions</a></span>
